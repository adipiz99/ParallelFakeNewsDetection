...
path = "test/test_sa_1/test_sa_1_1_results_dynamic"
...
path = "test/test_sa_1/test_sa_1_2_results_dynamic/"
...
rects2 = ax.bar(r2, scores_sa_5, width, label='sa delay 5', color='darkblue', hatch='x', zorder=0)
rects3 = ax.bar(r3, scores_sa_4, width, label='sa delay 4', color='mediumblue', hatch='xx')
rects4 = ax.bar(r4, scores_sa_2, width, label = "sa delay 2", color="royalblue", hatch='/'),
