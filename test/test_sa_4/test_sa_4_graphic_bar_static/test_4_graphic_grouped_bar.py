...
path = "test/test_sa_4/test_sa_4_2_results_dynamic/"
...
path = "test/test_sa_4/test_sa_4_3_results_dynamic/"
...
rects2 = ax.bar(r2, scores_sa_10, width, label='sa NR = 0.10', color='darkblue', hatch='x', zorder=0)
rects3 = ax.bar(r3, scores_sa_20, width, label='sa NR = 0.20', color='mediumblue', hatch='xx')
rects4 = ax.bar(r4, scores_sa_30, width, label = "sa NR = 0.30", color="royalblue", hatch='/')
...
labels = ['Single-view']
ax.legend([rects1,rects2,rects3,rects4,linea],('No sa, no bias','sa NR = 0.10', 'sa NR = 0.20', 'sa NR = 0.30','Virality 0.5'))
